...
public class SpecialityRepositoryArray implements ISpecialityRepository {
	...
	public SpecialityRepositoryArray() {
		...
		indice = 0;
		try {
			this.insert(new MedicalSpeciality("Urology"));
			this.insert(new MedicalSpeciality("Cardiology"));
			this.insert(new MedicalSpeciality("Oncology"));
			this.insert(new MedicalSpeciality("Psicotherapy"));
			this.insert(new MedicalSpeciality("Odontology"));
